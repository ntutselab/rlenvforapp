...
class StopApplicationUnderTestUseCase:
    ...
    def execute(self, input: StopApplicationUnderTestInput.StopApplicationUnderTestInput, output: StopApplicationUnderTestOutput.StopApplicationUnderTestOutput):
        autId = input.getId()
