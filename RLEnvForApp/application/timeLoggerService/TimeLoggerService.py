...
class TimeLoggerService:
    ...
    def log_start(self, logDir):
        ...
        self._write_file(path=savePath, content=savedContent)
        return startTimeSeconds

    def log_stop(self, logDir):
    ...
    def log_second_diff(self, startTimeSeconds, stopTimeSeconds, logDir):
        ...
        savedContent = savedContent + self._get_format_time(diffSeconds)
        self._write_file(path=savePath, content=savedContent)
        return diffSeconds
    ...
    def _get_format_time(self, timeSeconds):
